function FallingItem(p_img, p_type, p_speed, p_score, p_x, p_id) {
  ...
  this.score = p_score; // how much point each obj has
  this.width;
  this.height;
  this.xPos = p_x; // left of the item, 0px~(400-40)px
  this.yPos = 0;
  this.detected = false;

  // Create an object inside of area
  var foodItem = document.createElement("img");
  foodItem.src = "img/" + p_img + ".svg";
  foodItem.id = p_id; // may not necessary
